...
function send() {
	number1 = document.getElementById("number1", player1_name).value;
	number2 = document.getElementById("number2", player2_name).value;
...
function check()
{
	...
	{
		answer_turn = "player1"
		document.getElementById("player1_answer").innerHTML = "Answer Turn - " + player1_name ;
	}
